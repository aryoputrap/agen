...
export default class Cameramasuk extends PureComponent {
  ...
  kirimAbsen = () => {
    ...
    console.log(user);
    const token =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJib2R5IjpbMTQsImFrdXNpc2kiLDNdLCJpYXQiOjE1Nzk3NzA0NzQsImV4cCI6MTU3OTc5OTI3NH0.Bqtobie05XBlwVxCP_8FH5DnGDLRmSoo48qOfDki7yA';
  ...
  takefrontPhoto = () => {
    setTimeout(() => {
      captureScreen({
        ...
        .then(
          this.setState({status: 'OUT', openCamera: 'start', kirimAbsen: true}),
        )
