...
export default class absen extends Component {
  ...
  kirimAbsen = () => {
    ...
    console.log(user);
    const token =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJib2R5IjpbMTQsImFrdXNpc2kiLDNdLCJpYXQiOjE1Nzk3NTUzMzYsImV4cCI6MTU3OTc4NDEzNn0.R7rTOq3BicmHvHc5--nKoIRHynh1eHJTl5D2vbqk79U';
  ...
  componentDidMount() {
    ...
    axios({
      method: 'GET',
      url: 'http://support.tokopandai.id:3003/Api/absen/14',
      headers: header,
    })
      .then(response => {
        this.response = response.data;
        console.log(response.data.data[0].encode);
        // console.log(response.data.encode);
